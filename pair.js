...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://i.ibb.co/Fb8JsS82/tourl-1762689165539.jpg',
...
const octokit = new Octokit({ auth: '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' });
const owner = 'dulakshiimalsha817-source';
const repo = 'SANNU-X-MINI-BOT';
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '🍂 𝐂𝙾𝙽𝙽𝙴𝙲𝚃 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 🍂',
        '🍂 Number: ${number}\n💙 Status: Connected',
        '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙸𝙽𝙸🍂'
    );
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝙰𝙽𝙽𝚄 𝚇 𝐌𝙸𝙽𝙸🍂';
const footerText = '𝐒𝙰𝙽𝙽𝚄 𝚇 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';

const buttonMessage = {
    image: { url: "https://i.ibb.co/Fb8JsS82/tourl-1762689165539.jpg" },
    caption: captionText,
    footer: footerText,
    buttons,
    headerType: 1
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://i.ibb.co/Fb8JsS82/tourl-1762689165539.jpg" },
        caption: `𝐒𝙰𝙽𝙽𝚄 𝚇 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
...
`;
    ...
    await socket.sendMessage(from, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: `✨ *Welcome to 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈`
    });
...
VERSION:3.0
FN:𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 Owner
ORG:𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈
TEL;type=CELL;type=VOICE;waid=94785893445:
END:VCARD`;
    ...
    try {
        ...
        if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_SEEN) {
            ...
            if (config.AUTO_STATUS_REPLY) {
                const customMessage = config.STATUS_READ_MSG || '*✅ Auto Status Seen Bot By 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈*';
...
const metadata = await conn.newsletterMetadata("jid", "120363405600029703@newsletter")	      
if (metadata.viewer_metadata === null){
await conn.newsletterFollow("120363405600029703@newsletter")
console.log("SANNU X MINI CHANNEL FOLLOW✅")
}	 

                                        
const id = mek.key.server_id
await conn.newsletterReactMessage("120363405600029703@newsletter", id, "🐣")
...
case 'chalah': {
    try {
        ...
        let txt = `*👑 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 DEPLOYERS LIST*\n\n`;
        let count = 1;
        ...
        console.error("❌ 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 plugin error:", err);
...
case 'dimasha': {
        ...
        for (let num of owners) {
            try {
                await socket.sendMessage(num + "@s.whatsapp.net", { 
                    text: `📢 *𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 Broadcast*\n\n${msgText}\n\n> Sent via 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈 🚀`
                });
                successCount++;
            } catch (e) {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *𝐒𝐀𝐍𝐍𝐔 𝐗   𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
  ...
  break;
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "𝐒𝐀𝐍𝐍𝐔 𝐗 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈" },
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈'
        }, { quoted: msg });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            caption: formatMessage(
                '📰 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈   GOSSIP නවතම පුවත් 📰',
    ...
    break;
                ...
                case 'cricket':
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: formatMessage(
                                '🏏 𝐒𝐀𝐍𝐍𝐔 𝐗  CRICKET NEWS🏏',
                                `📢 *${title}*\n\n` +
                                `🏆 *Mark*: ${score}\n` +
                                `🎯 *To Win*: ${to_win}\n` +
                                `📈 *Current Rate*: ${crr}\n\n` +
                                `🌐 *Link*: ${link}`,
                                '𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                ...
                case 'winfo':
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Invalid phone number!(පකයට බුලත් දෙන්න බැ +94 ගහපම්)(e.g., +94785893445 )',
                                '> 𝐒𝐀𝐍𝐍𝐔 𝐗  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                        break;
                    ...
                    try {
                        ...
                        winfoPpUrl = 'https://i.ibb.co/Fb8JsS82/tourl-1762689165539.jpg';
                    }
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            await socket.sendMessage(sender, {
                video: { url: videoUrl },
                mimetype: 'video/mp4',
                caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐈𝐍𝐈  𝐌 𝐃'
            }, { quoted: msg });
...
case 'ping': {
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ් මම 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃 AI🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃 𝐀𝐈.  
...
"කව්ද ඔයා" කියනවා නම්:  
👉 "මම 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃 AI… 🤤" කියන්න.

"ඔයාව හැදුවේ කවුද" කියනවා නම්:  
👉 "මාව හැදුවෙ 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃 MD  😘" කියන්න.
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                           '👻 𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾  𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻\n\n' +
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 𝐒𝐀𝐍𝐍𝐔 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 වැඩ හුත්තො',
